...
function fillBallotData() {
	let data;
	if (typeof ballotId === 'undefined' && pairingId !== 'undefined') {
		data = `pairing=${pairingId}`;
	} else if (ballotId !== 'undefined') {
		data = `ballot=${ballotId}`;
	}
	$.get("api/judgeBallots/getBallotData.php", data, (ballot) => {
...
function updateName(name) {
	let data = { name: name }
	$.post("api/judgeBallots/updateName.php", data, () => { }, "json");
}
...
function submitBallot() {
	let data = {
		...
		pWCx3: $("#pWCx3").val(),
		pClose: $("#pClose").val(),
		pOpenComments: $("#pOpenComments").val(),
		pDx1Comments: $("#pDx1Comments").val(),
		pDx2Comments: $("#pDx2Comments").val(),
		pDx3Comments: $("#pDx3Comments").val(),
		pCx1Comments: $("#pCx1Comments").val(),
		pCx2Comments: $("#pCx2Comments").val(),
		pCx3Comments: $("#pCx3Comments").val(),
		pWDx1Comments: $("#pWDx1Comments").val(),
		pWDx2Comments: $("#pWDx2Comments").val(),
		pWDx3Comments: $("#pWDx3Comments").val(),
		pWCx1Comments: $("#pWCx1Comments").val(),
		pWCx2Comments: $("#pWCx2Comments").val(),
		pWCx3Comments: $("#pWCx3Comments").val(),
		pCloseComments: $("#pCloseComments").val(),
		dOpen: $("#dOpen").val(),
		dDx1: $("#dDx1").val(),
		dDx2: $("#dDx2").val(),
		dDx3: $("#dDx3").val(),
		...
		dWCx3: $("#dWCx3").val(),
		dClose: $("#dClose").val(),
		dOpenComments: $("#dOpenComments").val(),
		dDx1Comments: $("#dDx1Comments").val(),
		dDx2Comments: $("#dDx2Comments").val(),
		dDx3Comments: $("#dDx3Comments").val(),
		dCx1Comments: $("#dCx1Comments").val(),
		dCx2Comments: $("#dCx2Comments").val(),
		dCx3Comments: $("#dCx3Comments").val(),
		dWDx1Comments: $("#dWDx1Comments").val(),
		dWDx2Comments: $("#dWDx2Comments").val(),
		dWDx3Comments: $("#dWDx3Comments").val(),
		dWCx1Comments: $("#dWCx1Comments").val(),
		dWCx2Comments: $("#dWCx2Comments").val(),
		dWCx3Comments: $("#dWCx3Comments").val(),
		dCloseComments: $("#dCloseComments").val(),
		aty1: $("#aty1").val(),
		aty2: $("#aty2").val(),
		aty3: $("#aty3").val(),
		aty4: $("#aty4").val(),
	...
	$.post("api/judgeBallots/submit.php", data, () => { }, "json");
}
...
function updateScore(part, score) {
	...
	$.post("api/judgeBallots/updateScore.php", data, () => { }, "json");
}
...
function updateComment(part, comment) {
	...
	$.post("api/judgeBallots/updateComment.php", data, () => { }, "json");
}