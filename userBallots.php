...
<head>
	...
	<link rel="stylesheet" href="userBallots.css">
...
<body>
	<div style='display: grid'>
		<div style='grid-row: 1 / span 1; grid-column: 1 / span 1'>Round</div>
		<div style='grid-row: 1 / span 1; grid-column: 2 / span 1'>Pairing</div>
		<div style='grid-row: 1 / span 1; grid-column: 3 / span 1'>Ballot</div>
		<div style='grid-row: 2 / span 1; grid-column: 1 / span 1'><select id='round'>
		...
		<div style='grid-row: 2 / span 1; grid-column: 2 / span 1'><select id='pairing'></select></div>
		<div style='grid-row: 2 / span 1; grid-column: 3 / span 1'><select id='ballot'></select></div>
	</div>
	<div>
	...
	<script src="userBallots.js"></script>
</body>
